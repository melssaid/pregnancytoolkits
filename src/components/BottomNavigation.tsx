      ...
      <>
        ...
        <nav ref={ref} className="fixed bottom-0 left-0 right-0 z-50 md:hidden safe-area-bottom">
          <div className="relative">
            ...
            {isPremium && (
              <motion.div
                className="absolute -top-3 className="absolute -top-3 left-1/2 -translate-x-1/2 z-20 w-7 h-7 rounded-full bg-gradient-to-br from-[hsl(45,80%,60%)] to-[hsl(35,70%,45%)] flex items-center justify-center shadow-lg ring-2 ring-card" z-20 w-7 h-7 rounded-full bg-gradient-to-br from-[hsl(45,80%,60%)] to-[hsl(35,70%,45%)] flex items-center justify-center shadow-lg ring-2 ring-card"
