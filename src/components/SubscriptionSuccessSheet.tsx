...
const i18nLabels: Record<string, {
  ...
  ar: {
    ...
    creditsBadge: 'تم منحكِ 75 نقطة',
    perks: [
      '75 تحليل ذكاء اصطناعي شهرياً',
  ...
  fr: {
    ...
    creditsBadge: '75 crédits accordés',
    perks: [
      '75 analyses IA par mois',
  ...
  es: {
    ...
    creditsBadge: '75 créditos otorgados',
    perks: [
      '75 análisis IA por mes',
  ...
  pt: {
    ...
    creditsBadge: '75 créditos concedidos',
    perks: [
      '75 análises IA por mês',
