...
const i18nLabels: Record<string, {
  ...
  en: {
    ...
    perks: ['60 AI analyses per month', 'All 36+ smart tools unlocked', 'Personalized health insights', 'Priority support'],
    cta: 'Start Exploring',
  ...
  ar: {
    ...
    perks: ['60 تحليل ذكاء اصطناعي شهرياً', 'جميع أدوات الذكاء الاصطناعي 42+', 'رؤى صحية مخصصة', 'دعم أولوية'],
    cta: 'ابدئي الاستكشاف',
  ...
  de: {
    ...
    perks: ['60 KI-Analysen pro Monat', 'Alle 36+ KI-Tools freigeschaltet', 'Personalisierte Gesundheitseinblicke', 'Prioritäts-Support'],
    cta: 'Jetzt entdecken',
  ...
  fr: {
    ...
    perks: ['60 analyses IA par mois', 'Tous les 36+ outils intelligents débloqués', 'Conseils santé personnalisés', 'Support prioritaire'],
  ...
  es: {
    ...
    perks: ['60 análisis IA por mes', 'Todas las 36+ herramientas IA', 'Información de salud personalizada', 'Soporte prioritario'],
  ...
  pt: {
    ...
    perks: ['60 análises IA por mês', 'Todas as 36+ ferramentas IA', 'Insights de saúde personalizados', 'Suporte prioritário'],
  ...
  tr: {
    ...
    perks: ['Ayda 60 AI analizi', 'Tüm 36+ akıllı araç açık', 'Kişiselleştirilmiş sağlık önerileri', 'Öncelikli destek'],
