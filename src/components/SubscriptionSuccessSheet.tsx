...
const i18nLabels: Record<string, {
  ...
  en: {
    ...
    perks: ['60 AI analyses per month', 'All 33+ smart tools unlocked', 'Personalized health insights', 'Priority support'],
    cta: 'Start Exploring',
  ...
  de: {
    ...
    perks: ['60 KI-Analysen pro Monat', 'Alle 33+ KI-Tools freigeschaltet', 'Personalisierte Gesundheitseinblicke', 'Prioritäts-Support'],
    cta: 'Jetzt entdecken',
