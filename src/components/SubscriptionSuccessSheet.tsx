...
const i18nLabels: Record<string, {
  ...
  en: {
    ...
    perks: ['60 AI analyses per month', 'All 42+ AI tools unlocked', 'Personalized health insights', 'Priority support'],
    cta: 'Start Exploring',
  ...
  ar: {
    ...
    perks: ['40 تحليل ذكاء اصطناعي شهرياً', 'جميع أدوات الذكاء الاصطناعي 22+', 'رؤى صحية مخصصة', 'دعم أولوية'],
    cta: 'ابدئي الاستكشاف',
  ...
  fr: {
    ...
    perks: ['40 analyses IA par mois', 'Tous les 22+ outils IA débloqués', 'Conseils santé personnalisés', 'Support prioritaire'],
  ...
  pt: {
    ...
    perks: ['40 análises IA por mês', 'Todas as 22+ ferramentas IA', 'Insights de saúde personalizados', 'Suporte prioritário'],
