...
export function TrialExpiryBanner() {
  ...
  const variants: Record<string, { text: string; cta: string }[]> = {
    ar: [
      ...
      { text: "👑 75 تحليلاً شهرياً + ميزات حصرية", cta: "ترقية" },
    ...
    de: [
      ...
      { text: "👑 75 Analysen/Monat + exklusive Features", cta: "Upgrade" },
    ...
    fr: [
      ...
      { text: "👑 75 analyses/mois + fonctions exclusives", cta: "Passer" },
    ...
    es: [
      ...
      { text: "👑 75 análisis/mes + funciones exclusivas", cta: "Mejorar" },
    ...
    pt: [
      ...
      { text: "👑 75 análises/mês + recursos exclusivos", cta: "Upgrade" },
    ...
    tr: [
      ...
      { text: "👑 Aylık 75 analiz + özel özellikler", cta: "Yükselt" },
