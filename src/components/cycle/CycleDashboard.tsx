      ...
      <CardContent className="pt-5 pb-4 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <p className="text-4xl font-extrabold text-rose-600 dark:text-rose-400 tabular-nums tracking-tight"><CountUpNumber value={stats.daysToPeriod} /></p>
            <p className="text-[11px] text-muted-foreground mt-0.5 font-medium">
        ...
        <div className="flex items-center justify-between text-center">
          <div className="flex-1">
            <p className="text-2xl font-extrabold text-foreground tabular-nums"><CountUpNumber value={stats.avgCycle} /></p>
