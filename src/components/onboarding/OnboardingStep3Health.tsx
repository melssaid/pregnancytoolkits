  ...
  return (
    ...
    >
      ...
      <div className="px-4 pb-3 space-y-3">
        ...
        <div>
          <label className="text-[11px] font-medium text-muted-foreground block mb-1">
            <Droplets className="w-3 h-3 inline me-1" />
            ...
            {HEALTH_CONDITIONS.map((c) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "w-full flex items-center gap-2.5 px-3 py-2 rounded-lg border text-xs text-start transition-colors",
                    isSelected
                ...
                >
                  ...
                  {t(`onboarding.step3.condition.${c}`)}
                </button>
              );
            })}
          </div>
