...
export const skincareVideosByLang = (t: (key: string) => string): VideosByLang => ({
  ...
  tr: [
    ...
    { id: "3", title: "Dermatolog Rehberi: Hamilelikte Cilt", description: "Güvenli bileşenler ve cilt bakımı alternatifleri", youtubeId: "9NvKchuLIUw", duration: "14:00", category: "Cilt Bakımı" },
    { id: "4", title: "Çatlak Önleme İpuçları", description: "Hamilelikte çatlak oluşumunu azaltma yöntemleri", youtubeId: "Zmepuxvn9ck", duration: "10:00", category: "Önleme" },
  ],
  de: [
    ...
    { id: "3", title: "Dermatologin erklärt: Sichere Hautpflege", description: "Sichere Inhaltsstoffe und Alternativen in der Schwangerschaft", youtubeId: "9NvKchuLIUw", duration: "14:00", category: "Hautpflege" },
    { id: "4", title: "Dehnungsstreifen vorbeugen", description: "Methoden zur Vorbeugung von Dehnungsstreifen", youtubeId: "Zmepuxvn9ck", duration: "10:00", category: "Vorbeugung" },
  ],
  fr: [
    ...
    { id: "3", title: "Guide dermatologue : soins de grossesse", description: "Ingrédients sûrs et alternatives pour la peau enceinte", youtubeId: "9NvKchuLIUw", duration: "14:00", category: "Soins peau" },
    { id: "4", title: "Prévenir les vergetures", description: "Méthodes pour réduire les vergetures pendant la grossesse", youtubeId: "Zmepuxvn9ck", duration: "10:00", category: "Prévention" },
  ],
  es: [
    ...
    { id: "3", title: "Guía dermatológica: piel en el embarazo", description: "Ingredientes seguros y alternativas para la piel", youtubeId: "9NvKchuLIUw", duration: "14:00", category: "Cuidado piel" },
    { id: "4", title: "Prevenir estrías", description: "Métodos para reducir las estrías durante el embarazo", youtubeId: "Zmepuxvn9ck", duration: "10:00", category: "Prevención" },
  ],
  pt: [
    ...
    { id: "3", title: "Guia dermatológico: pele na gestação", description: "Ingredientes seguros e alternativas para a pele", youtubeId: "9NvKchuLIUw", duration: "14:00", category: "Cuidados pele" },
    { id: "4", title: "Prevenir estrias", description: "Métodos para reduzir estrias durante a gravidez", youtubeId: "Zmepuxvn9ck", duration: "10:00", category: "Prevenção" },
  ],
  default: [
