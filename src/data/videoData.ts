...
export const birthPositionVideosByLang: VideosByLang = {
  ...
  tr: [
    { id: "1", title: "Doğumda En İyi Pozisyonlar", description: "Doğum sırasında etkili ıkınma pozisyonları", youtubeId: "npGb1aHQteo", duration: "10:00", category: "Doğum" },
  ...
  de: [
    { id: "1", title: "Beste Geburtspositionen", description: "Effektive Positionen für die Geburt", youtubeId: "npGb1aHQteo", duration: "10:00", category: "Geburt" },
  ...
  fr: [
    { id: "1", title: "Meilleures positions d'accouchement", description: "Positions efficaces pour la poussée", youtubeId: "npGb1aHQteo", duration: "10:00", category: "Accouchement" },
  ...
  es: [
    { id: "1", title: "Mejores posiciones de parto", description: "Posiciones efectivas para el parto natural", youtubeId: "npGb1aHQteo", duration: "10:00", category: "Parto" },
  ...
  pt: [
    { id: "1", title: "Melhores posições de parto", description: "Posições eficazes para o parto natural", youtubeId: "npGb1aHQteo", duration: "10:00", category: "Parto" },
...
export const lactationVideosByLang: VideosByLang = {
  ...
  tr: [
    { id: "1", title: "Emzirme Rehberi", description: "Yenidoğan emzirme teknikleri ve ipuçları", youtubeId: "rNjJyTga__w", duration: "20:00", category: "Başlangıç" },
  ...
  de: [
    { id: "1", title: "Stillen - Anfängerguide", description: "Umfassender Stillratgeber für Neugeborene", youtubeId: "rNjJyTga__w", duration: "20:00", category: "Anfang" },
  ...
  fr: [
    { id: "1", title: "Guide d'allaitement", description: "Guide complet pour allaiter un nouveau-né", youtubeId: "rNjJyTga__w", duration: "20:00", category: "Début" },
  ...
  es: [
    { id: "1", title: "Guía de lactancia materna", description: "Guía completa para amamantar al recién nacido", youtubeId: "rNjJyTga__w", duration: "20:00", category: "Inicio" },
  ...
  pt: [
    { id: "1", title: "Guia de amamentação", description: "Guia completo para amamentar o recém-nascido", youtubeId: "rNjJyTga__w", duration: "20:00", category: "Início" },
...
export const partnerVideosByLang = (t: (key: string) => string): VideosByLang => ({
  ...
  tr: [
    ...
    { id: "3", title: "Birlikte Doğuma Hazırlık", description: "Doğum hazırlığına eşinizle birlikte katılma", youtubeId: "nc8IbAAotHo", duration: "15:00", category: "Hazırlık" },
  ...
  de: [
    ...
    { id: "3", title: "Gemeinsam Geburtsvorbereitung", description: "Gemeinsam zur Geburt vorbereiten", youtubeId: "nc8IbAAotHo", duration: "15:00", category: "Vorbereitung" },
  ...
  fr: [
    ...
    { id: "3", title: "Préparer l'accouchement ensemble", description: "Participer ensemble à la préparation", youtubeId: "nc8IbAAotHo", duration: "15:00", category: "Préparation" },
  ...
  es: [
    ...
    { id: "3", title: "Prepararse juntos para el parto", description: "Participar juntos en la preparación del parto", youtubeId: "nc8IbAAotHo", duration: "15:00", category: "Preparación" },
  ...
  pt: [
    ...
    { id: "3", title: "Preparar-se juntos para o parto", description: "Participar juntos na preparação do parto", youtubeId: "nc8IbAAotHo", duration: "15:00", category: "Preparação" },
...
export const mentalHealthVideosByLang = (t: (key: string) => string): VideosByLang => ({
  ...
  tr: [
    { id: "1", title: "Doğum Sonrası Ruh Sağlığı", description: "Doğum sonrası depresyonu anlamak ve tedavisi", youtubeId: "6kV2_L3uSS0", duration: "8:30", category: "Ruh Sağlığı" },
    { id: "2", title: "Doğum Sonrası Depresyon", description: "Belirtileri, nedenleri ve tedavi yöntemleri", youtubeId: "Aj1Vk3q-4tg", duration: "10:15", category: "Ruh Sağlığı" },
    { id: "3", title: "Anneler İçin Rahatlama Meditasyonu", description: "Yeni anneler için sakinleştirici meditasyon", youtubeId: "pCSjhbVOdYQ", duration: "60:00", category: "Meditasyon" },
    { id: "4", title: "Yenidoğan Bakımı - Kaygıyı Azaltma", description: "Bebek bakım rehberi - kaygıyı hafifletir", youtubeId: "hpgjwK_oQe0", duration: "18:00", category: "Bakım" },
  ],
  de: [
    { id: "1", title: "Psychische Gesundheit nach der Geburt", description: "Postpartale Depression verstehen und behandeln", youtubeId: "6kV2_L3uSS0", duration: "8:30", category: "Psychische Gesundheit" },
    { id: "2", title: "Wochenbettdepression", description: "Symptome, Ursachen und Behandlung", youtubeId: "Aj1Vk3q-4tg", duration: "10:15", category: "Psychische Gesundheit" },
    { id: "3", title: "Entspannungsmeditation für Mütter", description: "Beruhigende Meditation für junge Mütter", youtubeId: "pCSjhbVOdYQ", duration: "60:00", category: "Meditation" },
    { id: "4", title: "Neugeborenen-Pflege - Angst reduzieren", description: "Pflegeführer zur Angstreduktion", youtubeId: "hpgjwK_oQe0", duration: "18:00", category: "Pflege" },
  ],
  fr: [
    { id: "1", title: "Santé mentale post-partum", description: "Comprendre et traiter la dépression post-partum", youtubeId: "6kV2_L3uSS0", duration: "8:30", category: "Santé mentale" },
    { id: "2", title: "Dépression post-partum", description: "Symptômes, causes et traitements", youtubeId: "Aj1Vk3q-4tg", duration: "10:15", category: "Santé mentale" },
    { id: "3", title: "Méditation relaxante pour mamans", description: "Méditation apaisante pour jeunes mamans", youtubeId: "pCSjhbVOdYQ", duration: "60:00", category: "Méditation" },
    { id: "4", title: "Soins du nouveau-né - Réduire l'anxiété", description: "Guide de soins pour réduire l'anxiété", youtubeId: "hpgjwK_oQe0", duration: "18:00", category: "Soins" },
  ],
  es: [
    { id: "1", title: "Salud mental posparto", description: "Comprender y tratar la depresión posparto", youtubeId: "6kV2_L3uSS0", duration: "8:30", category: "Salud mental" },
    { id: "2", title: "Depresión posparto", description: "Síntomas, causas y tratamientos", youtubeId: "Aj1Vk3q-4tg", duration: "10:15", category: "Salud mental" },
    { id: "3", title: "Meditación relajante para mamás", description: "Meditación calmante para nuevas mamás", youtubeId: "pCSjhbVOdYQ", duration: "60:00", category: "Meditación" },
    { id: "4", title: "Cuidados del recién nacido - Reducir ansiedad", description: "Guía de cuidados para reducir la ansiedad", youtubeId: "hpgjwK_oQe0", duration: "18:00", category: "Cuidados" },
  ],
  pt: [
    { id: "1", title: "Saúde mental pós-parto", description: "Compreender e tratar a depressão pós-parto", youtubeId: "6kV2_L3uSS0", duration: "8:30", category: "Saúde mental" },
    { id: "2", title: "Depressão pós-parto", description: "Sintomas, causas e tratamentos", youtubeId: "Aj1Vk3q-4tg", duration: "10:15", category: "Saúde mental" },
    { id: "3", title: "Meditação relaxante para mães", description: "Meditação calmante para novas mães", youtubeId: "pCSjhbVOdYQ", duration: "60:00", category: "Meditação" },
    { id: "4", title: "Cuidados com recém-nascido - Reduzir ansiedade", description: "Guia de cuidados para reduzir a ansiedade", youtubeId: "hpgjwK_oQe0", duration: "18:00", category: "Cuidados" },
  ],
  default: [
...
export const generalVideosByLang: VideosByLang = {
  ...
  tr: [
    ...
    { id: "8", youtubeId: "rNjJyTga__w", title: "Emzirme Rehberi", description: "Yenidoğan emzirme teknikleri", category: "Bebek Bakımı", duration: "20:00" },
  ...
  de: [
    ...
    { id: "7", youtubeId: "rNjJyTga__w", title: "Stillen - Anfängerguide", description: "Umfassender Stillratgeber", category: "Babypflege", duration: "20:00" },
  ...
  fr: [
    ...
    { id: "7", youtubeId: "rNjJyTga__w", title: "Guide d'allaitement", description: "Guide complet pour l'allaitement", category: "Soins bébé", duration: "20:00" },
  ...
  es: [
    ...
    { id: "8", youtubeId: "rNjJyTga__w", title: "Guía de lactancia materna", description: "Guía completa de lactancia", category: "Cuidado bebé", duration: "20:00" },
  ...
  pt: [
    ...
    { id: "8", youtubeId: "rNjJyTga__w", title: "Guia de amamentação", description: "Guia completo de amamentação", category: "Cuidados bebê", duration: "20:00" },
