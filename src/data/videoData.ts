...
export const mentalHealthVideosByLang = (t: (key: string) => string): VideosByLang => ({
  ...
  fr: [
    ...
    { id: "3", title: "Dépression post-partum - Tout comprendre", description: "Explication complète de la dépression post-partum par des professionnels", youtubeId: "SQtfpsPIRwQ", duration: "15:00", category: "Compréhension" },
