...
export const generalVideosByLang: VideosByLang = {
  ar: [
    ...
    { id: "4", youtubeId: "ok45m94bdTw", title: "الحالة النفسية للحامل وتأثيرها على الجنين", description: "أخصائية نسائية تشرح تأثير نفسية الأم على الجنين", category: "صحة نفسية", duration: "10:00" },
    ...
    { id: "9", youtubeId: "NBYRLg8btZw", title: "تجهيز شنطة الولادة", description: "قائمة شاملة بكل ما تحتاجينه في حقيبة المستشفى", category: "تحضير", duration: "12:00" },
    { id: "10", youtubeId: "917-9qGEx0E", title: "التعامل مع الرضيع من الألف للياء", description: "دليل شامل للتعامل مع المولود الجديد", category: "رعاية المولود", duration: "20:00" },
    { id: "11", youtubeId: "XzPHm2Z_aZ4", title: "الرضاعة الطبيعية - دليل شامل", description: "كورس تأهيلي عن أساسيات الرضاعة الطبيعية", category: "رعاية المولود", duration: "15:00" },
    { id: "12", youtubeId: "Axp5Vbj8-2A", title: "العناية بالبشرة أثناء الحمل", description: "التصبغات وكلف الحمل وطرق العلاج", category: "عناية بالبشرة", duration: "15:00" },
  ],
  tr: [
...
export const cycleTrackerVideosByLang: VideosByLang = {
  ar: [
    ...
    { id: "3", title: "حساب يوم التبويض", description: "أسهل طريقة لحساب يوم التبويض وتحديد اليوم الذهبي للحمل", youtubeId: "hKup8j8xY-Q", duration: "15:00", category: "خصوبة" },
    { id: "4", title: "علامات تلقيح البويضة", description: "علامات تلقيح البويضة وانغماس الجنين قبل نزول الدورة", youtubeId: "MKQjMgmFW6s", duration: "12:00", category: "خصوبة" },
  ],
  tr: [
    ...
    { id: "3", title: "Ovulasyon Testi Nasıl Yapılır", description: "Yumurtlama testinin önemi ve doğru kullanımı", youtubeId: "GriRydmtnG0", duration: "12:00", category: "Takip" },
    { id: "4", title: "Kadınlar Neden Adet Görür", description: "Adet döngüsünün bilimsel açıklaması", youtubeId: "8foCUjjoc9Y", duration: "10:00", category: "Eğitim" },
  ],
  de: [
    ...
    { id: "4", title: "Was ist Periode und Menstruationszyklus?", description: "Einfache Erklärung der Periode und des Zyklus", youtubeId: "yFZQAYsw7xY", duration: "8:00", category: "Bildung" },
  ],
  fr: [
    ...
    { id: "3", title: "Calculer l'ovulation", description: "Le moment idéal pour tomber enceinte", youtubeId: "n517uxpX1O0", duration: "8:00", category: "Fertilité" },
    { id: "4", title: "Glaire cervicale et ovulation", description: "Aspect de la glaire cervicale tout au long du cycle", youtubeId: "xu0TVlQ97X0", duration: "11:00", category: "Fertilité" },
  ],
  es: [
    ...
    { id: "2", title: "Cómo calcular días fértiles", description: "Calcula tu periodo de ovulación y días fértiles", youtubeId: "87e-2482y4s", duration: "10:00", category: "Fertilidad" },
    { id: "3", title: "Signos de la ovulación", description: "Cómo saber si estoy ovulando y cuáles son mis días fértiles", youtubeId: "XTthzxGZjD8", duration: "12:00", category: "Fertilidad" },
    { id: "4", title: "Ciclo menstrual y días fértiles", description: "Conoce tu ciclo menstrual y días fértiles", youtubeId: "3jN8omNTKzk", duration: "9:00", category: "Salud" },
  ],
  pt: [
    ...
    { id: "2", title: "Identificar o período fértil", description: "Como calcular seu período fértil", youtubeId: "6L1oeXOOHt8", duration: "10:00", category: "Fertilidade" },
    { id: "3", title: "Método da tabelinha", description: "Entenda como funciona a tabelinha menstrual", youtubeId: "lh7sGNhBVhE", duration: "12:00", category: "Acompanhamento" },
    { id: "4", title: "Ciclos irregulares", description: "Causas e quando procurar o médico", youtubeId: "b5bvIgRDC3k", duration: "9:00", category: "Saúde" },
  ],
  default: [
    ...
    { id: "2", title: "Ovulation and Cycle Tracking", description: "Methods including BBT, cervical mucus, and OPKs", youtubeId: "LWRcGlQoT1Q", duration: "15:00", category: "Tracking" },
    { id: "3", title: "How to Track Your Cycle to Get Pregnant", description: "BBT charting and ovulation tracking explained", youtubeId: "vK5KKE6bd8g", duration: "12:00", category: "Fertility" },
    { id: "4", title: "Ovulation 101", description: "How to know if ovulation is actually happening", youtubeId: "KquoXUVHqaw", duration: "14:00", category: "Fertility" },
  ],
};
...
export const dueDateVideosByLang: VideosByLang = {
  ar: [
    ...
    { id: "3", title: "حساب موعد الولادة بدقة", description: "أدق طريقة لحساب أسابيع الحمل وموعد الولادة", youtubeId: "wHdWunNj6U0", duration: "5:00", category: "تعليمي" },
    { id: "4", title: "حساب عمر الجنين وموعد الولادة", description: "كيفية حساب الحمل وتحديد ميعاد الولادة", youtubeId: "f_2WtvqfUR4", duration: "10:00", category: "تعليمي" },
  ],
  tr: [
    ...
    { id: "3", title: "Gebelik Hesaplama Nasıl Yapılır", description: "Gebelik haftası hesaplama ve trimester değişimleri", youtubeId: "R94cK3ZHfaY", duration: "6:00", category: "Eğitim" },
    { id: "4", title: "Hafta Hafta Gebelik Takibi", description: "Gebeliğin 21. haftasında bebekte ve annede neler oluyor", youtubeId: "J-Fa159A02Y", duration: "6:00", category: "Takip" },
  ],
  de: [
    ...
    { id: "4", title: "Schwangerschaft Woche für Woche", description: "Entwicklung des Babys und Veränderungen bei der Mutter", youtubeId: "58ebyYd_8gY", duration: "15:00", category: "Entwicklung" },
  ],
  fr: [
    ...
    { id: "4", title: "Calculer la date de début de grossesse", description: "Trouvez votre date de début de grossesse et d'accouchement", youtubeId: "rjhHjVtZKPo", duration: "10:00", category: "Éducation" },
  ],
  es: [
    ...
    { id: "2", title: "Cómo calcular semanas de embarazo", description: "Método médico para contar las semanas de gestación", youtubeId: "ckSUtNDDHf8", duration: "8:00", category: "Educación" },
    { id: "3", title: "Fecha probable de parto", description: "Cómo calcular cuándo nacerá tu bebé", youtubeId: "6TTqni15PPc", duration: "8:00", category: "Educación" },
    { id: "4", title: "Ejercicios para el tercer trimestre", description: "Preparación física para las últimas semanas del embarazo", youtubeId: "mLVZoZ9KDBM", duration: "12:00", category: "Preparación" },
  ],
  pt: [
    ...
    { id: "4", title: "Suplementação para gestantes", description: "Vitaminas e nutrientes essenciais durante a gravidez", youtubeId: "seLZ_KQtOew", duration: "13:00", category: "Nutrição" },
  ],
  default: [
    ...
    { id: "4", title: "Best Way to Calculate Due Date", description: "Comprehensive guide to pregnancy due date calculation", youtubeId: "qzDMlt63_8c", duration: "10:00", category: "Education" },
  ],
};
