...
export async function exportDataBackupPDF(options: DataBackupPDFOptions): Promise<void> {
  ...
  const i18nLabels: Record<string, Record<string, string>> = {
    ...
    tr: { totalItems: 'Toplam öğe', healthData: 'Sağlık verileri', planning: 'Planlama', profile: 'Profil ve Ayarlar', health: 'Sağlık Takibi', appointments: 'Randevular ve Hatırlatıcılar', nutrition: 'Beslenme ve Yemekler', birthPlanning: 'Doğum Planı ve Hazırlık', other: 'Diğer veriler', items: 'öğe', noData: 'Veri yok', disclaimer: 'Bu rapor otomatik olarak oluşturulmuştur. Her zaman doktorunuza danışın.', generatedOn: 'Oluşturulma tarihi', dataEntries: 'Veri girdileri', categories: 'Kategoriler', records: 'kayıt', entry: 'girdi' },
  };
