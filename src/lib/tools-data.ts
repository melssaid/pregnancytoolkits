...
export const toolsData: Tool[] = [
  ...
  { id: "weight-gain", titleKey: "tools.weightGain.title", descriptionKey: "tools.weightGain.description", icon: Gauge, pngIcon: "https://img.icons8.com/ios-filled/50/D4657E/combo-chart--v1.png", categoryKey: "categories.pregnancy", href: "/tools/weight-gain", priority: 8, hasAI: true },
