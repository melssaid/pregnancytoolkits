...
export const toolsData: Tool[] = [
  ...
  // PREGNANCY TRACKING
  // ═══════════════════════════════════════════════════════════════
  { id: "fetal-growth", titleKey: "tools.fetalGrowth.title", descriptionKey: "tools.fetalGrowth.description", icon: TrendingUp, pngIcon: "https://img.icons8.com/ios-filled/50/D4657E/baby-app.png", categoryKey: "categories.pregnancy", href: "/tools/fetal-growth", priority: 6, hasAI: true },
  ...
  { id: "weight-gain", titleKey: "tools.weightGain.title", descriptionKey: "tools.weightGain.description", icon: Scale, pngIcon: "https://img.icons8.com/ios-filled/50/D4657E/scales--v1.png", categoryKey: "categories.pregnancy", href: "/tools/weight-gain", priority: 8, hasAI: true },
