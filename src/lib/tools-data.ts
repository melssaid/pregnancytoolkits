...
export const toolsData: Tool[] = [
  ...
  { id: "ai-baby-name-finder", titleKey: "tools.aiBabyNameFinder.title", descriptionKey: "tools.aiBabyNameFinder.description", icon: Sparkles, categoryKey: "categories.ai", href: "/tools/ai-baby-name-finder", priority: 9 },
  { id: "ai-posture-coach", titleKey: "tools.aiPostureCoach.title", descriptionKey: "tools.aiPostureCoach.description", icon: Users, categoryKey: "categories.wellness", href: "/tools/ai-posture-coach", priority: 10 },
  { id: "smart-stretch-reminder", titleKey: "tools.smartStretchReminder.title", descriptionKey: "tools.smartStretchReminder.description", icon: Sparkles, categoryKey: "categories.wellness", href: "/tools/smart-stretch-reminder", priority: 11 },
  { id: "ai-back-pain-relief", titleKey: "tools.aiBackPainRelief.title", descriptionKey: "tools.aiBackPainRelief.description", icon: Activity, categoryKey: "categories.wellness", href: "/tools/ai-back-pain-relief", priority: 12 },
  { id: "pregnancy-massage-guide", titleKey: "tools.pregnancyMassageGuide.title", descriptionKey: "tools.pregnancyMassageGuide.description", icon: Heart, categoryKey: "categories.wellness", href: "/tools/pregnancy-massage-guide", priority: 13 },
  { id: "ai-leg-cramp-preventer", titleKey: "tools.aiLegCrampPreventer.title", descriptionKey: "tools.aiLegCrampPreventer.description", icon: Thermometer, categoryKey: "categories.wellness", href: "/tools/ai-leg-cramp-preventer", priority: 14 },
  { id: "smart-walking-coach", titleKey: "tools.smartWalkingCoach.title", descriptionKey: "tools.smartWalkingCoach.description", icon: Footprints, categoryKey: "categories.wellness", href: "/tools/smart-walking-coach", priority: 15 },
  { id: "ai-craving-alternatives", titleKey: "tools.aiCravingAlternatives.title", descriptionKey: "tools.aiCravingAlternatives.description", icon: Utensils, categoryKey: "categories.wellness", href: "/tools/ai-craving-alternatives", priority: 16 },

  // ═══════════════════════════════════════════════════════════════
  // STAGE 1: PRE-PREGNANCY & FERTILITY
  // ═══════════════════════════════════════════════════════════════
  ...
  { id: "conception-calculator", titleKey: "tools.conceptionCalculator.title", descriptionKey: "tools.conceptionCalculator.description", icon: Calendar, categoryKey: "categories.fertility", href: "/tools/conception-calculator", priority: 22 },
  
  // ═══════════════════════════════════════════════════════════════
  // STAGE 2: PREGNANCY TRACKING
  // ═══════════════════════════════════════════════════════════════
  ...
  { id: "kegel-exercises", titleKey: "tools.kegelExercises.title", descriptionKey: "tools.kegelExercises.description", icon: Activity, categoryKey: "categories.wellness", href: "/tools/kegel-exercises", priority: 35 },
  { id: "meditation-yoga", titleKey: "tools.meditationYoga.title", descriptionKey: "tools.meditationYoga.description", icon: Flower2, categoryKey: "categories.wellness", href: "/tools/meditation-yoga", priority: 36 },
  ...
  { id: "weight-gain", titleKey: "tools.weightGain.title", descriptionKey: "tools.weightGain.description", icon: Scale, categoryKey: "categories.wellness", href: "/tools/weight-gain", priority: 42 },
  ...
  // SUPPORT
  // ═══════════════════════════════════════════════════════════════
  { id: "doctor-questions", titleKey: "tools.doctorQuestions.title", descriptionKey: "tools.doctorQuestions.description", icon: MessageCircle, categoryKey: "categories.support", href: "/tools/doctor-questions", priority: 80 },
];
