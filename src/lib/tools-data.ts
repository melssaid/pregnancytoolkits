...
export const toolsData: Tool[] = [
  ...
  // POSTPARTUM & BABY
  // ═══════════════════════════════════════════════════════════════
  { id: "postpartum-mental-health", titleKey: "tools.postpartumMentalHealth.title", descriptionKey: "tools.postpartumMentalHealth.description", icon: Brain, pngIcon: "https://img.icons8.com/3d-fluency/94/brain.png", categoryKey: "categories.postpartum", href: "/tools/mental-health-coach", priority: 36, hasAI: true },
  { id: "ai-lactation-prep", titleKey: "tools.aiLactationPrep.title", descriptionKey: "tools.aiLactationPrep.description", icon: Milk, pngIcon: "https://img.icons8.com/3d-fluency/94/baby-bottle.png", categoryKey: "categories.postpartum", href: "/tools/ai-lactation-prep", priority: 37, hasAI: true },
  { id: "postpartum-recovery", titleKey: "tools.postpartumRecovery.title", descriptionKey: "tools.postpartumRecovery.description", icon: Flower2, pngIcon: "https://img.icons8.com/3d-fluency/94/spa.png", categoryKey: "categories.postpartum", href: "/tools/postpartum-recovery", priority: 38, hasAI: true },
  { id: "baby-cry-translator", titleKey: "tools.babyCryTranslator.title", descriptionKey: "tools.babyCryTranslator.description", icon: Volume2, pngIcon: "https://img.icons8.com/3d-fluency/94/speaker.png", categoryKey: "categories.postpartum", href: "/tools/baby-cry-translator", priority: 39, hasAI: true },
  { id: "baby-sleep-tracker", titleKey: "tools.babySleepTracker.title", descriptionKey: "tools.babySleepTracker.description", icon: Moon, pngIcon: "https://img.icons8.com/3d-fluency/94/crescent-moon.png", categoryKey: "categories.postpartum", href: "/tools/baby-sleep-tracker", priority: 40, hasAI: true },
  { id: "baby-growth", titleKey: "tools.babyGrowth.title", descriptionKey: "tools.babyGrowth.description", icon: Ruler, pngIcon: "https://img.icons8.com/3d-fluency/94/ruler.png", categoryKey: "categories.postpartum", href: "/tools/baby-growth", priority: 41 },
  { id: "diaper-tracker", titleKey: "tools.diaperTracker.title", descriptionKey: "tools.diaperTracker.description", icon: Baby, pngIcon: "https://img.icons8.com/3d-fluency/94/baby.png", categoryKey: "categories.postpartum", href: "/tools/diaper-tracker", priority: 42 },
];
