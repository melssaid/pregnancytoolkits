    ...
    <Layout showBack>
      <div className="container py-6 pb-24">
        <div className="mx-auto max-w-3xl prose prose-slate dark:prose-invert">
          ...
          <p>
            This Privacy Notice for <strong>Pregnancy Toolkits</strong> ("we," "us," or "our") describes how and why 
            we might access, collect, store, use, and/or share ("process") your personal information when you use 
            our services ("Services"), including when you:
          </p>

          <ul>
            <li>Download and use our mobile application (Pregnancy Toolkits) or any other application of ours that links to this Privacy Notice.</li>
            <li>Engage with us in other related ways, including any marketing or events.</li>
          </ul>

          <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 my-6">
            <p className="font-semibold text-primary mb-2">Important Notice</p>
            <p className="text-sm">
              We offer all services without the collection of personal data. An application specialized in providing 
              tools to support pregnant women, stressing that no prescriptions or health consultations are provided, 
              no direct communication with the public, in addition to strict adherence not to collect user data for 
              any commercial purposes. The application is characterized by its high-quality tools and software hygiene, 
              which are developed according to the latest technical standards.
            </p>
          </div>
          ...
          <p>
            ...
            <a href="mailto:M.melssaid@gmail.com" className="text-primary hover:underline">M.melssaid@gmail.com</a>.
          </p>
          ...
          <ul>
            ...
            <li><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by visiting <a href="https://pregnancytools.lovable.app/contact" className="text-primary hover:underline">https://pregnancytools.lovable.app/contact</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</li>
          </ul>
          ...
          <p>
            ...
            data is handled and stored by Google Play. You may find their privacy notice link(s) here:{" "}
          ...
          <p>
            ...
            Perplexity. As outlined in this Privacy Notice, your input, output, and personal information will be 
            shared with and processed by these AI Service Providers to enable your use of our AI Products for 
            purposes outlined in "WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?". You must 
            not use the AI Products in any way that violates the terms or policies of any AI Service Provider.
          </p>
          ...
          <p>
            ...
            and our agreement with third parties. This ensures high security and safeguards your personal information 
          ...
          <p>
            ...
            equivalent age as specified by law in your jurisdiction, nor do we knowingly sell such personal information. 
            By using the Services, you represent that you are at least 18 or the equivalent age as specified by law 
            in your jurisdiction or that you are the parent or guardian of such a minor and consent to such minor 
            dependent's use of the Services. If we learn that personal information from users less than 18 years of 
            age or the equivalent age as specified by law in your jurisdiction has been collected, we will deactivate 
            the account and take reasonable measures to promptly delete such data from our records. If you become 
            aware of any data we may have collected from children under age 18 or the equivalent age as specified 
            by law in your jurisdiction, please contact us at{" "}
            <a href="mailto:M.melssaid@gmail.com" className="text-primary hover:underline">M.melssaid@gmail.com</a>.
          </p>
          ...
          <p>
            ...
            request human review. In certain circumstances, you may also have the right to object to the processing 
            of your personal information. You can make such a request by contacting us by using the contact details 
          ...
          <p>
            ...
            <a href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
              Member State data protection authority
            </a>{" "}
            or{" "}
            <a href="https://ico.org.uk/make-a-complaint/data-protection-complaints/data-protection-complaints/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
            ...
            <table className="min-w-full text-sm">
              <thead>
                <tr>
                  ...
                  <th className="text-left p-2 border">Collected</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                ...
                <tr>
                  <td className="p-2 border">B. Personal information as defined in the California Customer Records statute</td>
                  <td className="p-2 border">Name, contact information, education, employment, employment history, and financial information</td>
                  <td className="p-2 border">NO</td>
                </tr>
                <tr>
                  <td className="p-2 border">C. Protected classification characteristics under state or federal law</td>
                  <td className="p-2 border">Gender, age, date of birth, race and ethnicity, national origin, marital status, and other demographic data</td>
                  <td className="p-2 border">NO</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="p-2 border">Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements</td>
                  <td className="p-2 border">NO</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="p-2 border">H. Audio, electronic, sensory, or similar information</td>
                ...
                <tr>
                  <td className="p-2 border">K. Inferences drawn from collected personal information</td>
                ...
                <tr>
                  <td className="p-2 border">L. Sensitive personal information</td>
          ...
          <ul>
            ...
            <li>Right to obtain a list of specific third parties to which we have disclosed personal data (as permitted by applicable law, including the privacy law in Minnesota)</li>
          ...
          <p>
            ...
            <a href="https://pregnancytools.lovable.app/contact" className="text-primary hover:underline">
              https://pregnancytools.lovable.app/contact
            </a>
            , or by contacting us using the contact information provided below.
          </p>

          <h2>12. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
          <p>
            If you are located in the EEA or UK and you believe we are unlawfully processing your personal information, 
            you have the right to complain to your Member State data protection authority or UK data protection authority.
          </p>
          <p>
          ...
          <p>
            ...
            <a href="tel:+97333775705" className="text-primary hover:underline">+973 3377 5705</a>.
          </p>
          <p>
            You may also contact us through our contact page at:{" "}
            <a href="https://pregnancytools.lovable.app/contact" className="text-primary hover:underline">
              https://pregnancytools.lovable.app/contact
            </a>
          </p>
