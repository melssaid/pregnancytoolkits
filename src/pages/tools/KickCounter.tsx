...
import { Hand, Play, RotateCcw, Info, History, BarChart3 } from "lucide-react";
...
export default function KickCounter() {
  ...
  return (
    <Layout title="عداد الركلات" showBack>
        ...
        <div className="mx-auto max-w-2xl">
          ...
          >
              ...
              <TabsContent value="counter" className="space-y-6">
                <Card>
                  <CardHeader className="text-center">
                    ...
                    <CardDescription>
                      عدّي 10 ركلات لمراقبة نشاط الجنين
                    </CardDescription>
                  </CardHeader>
                    ...
                    {!isActive ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-muted-foreground mt-4">
                          اضغطي على الزر في كل مرة تشعرين بحركة
                        </p>
                      </div>
                    ) : (
                      <div className="space-y-6">
                        <div className="text-center">
                          <p className="text-sm text-muted-foreground mb-2">الوقت المنقضي</p>
                        ...
                        >
                          ...
                          <span className="text-sm text-primary-foreground/80">ركلة</span>
                        </motion.button>
                        ...
                        <div className="rounded-lg bg-success/10 border border-success/20 p-4 text-center">
                          <p className="text-sm text-success font-medium">
                            الهدف: 10 ركلات في ساعتين أو أقل
                          </p>
                          <p className="text-xs text-muted-foreground mt-1">
                            متبقي {10 - kicks} ركلات
                          </p>
                        </div>
                      </div>
                    )}
            ...
            <div className="mt-6 flex items-start gap-3 rounded-lg bg-muted p-4">
              ...
              <p className="text-sm text-muted-foreground">
                ابتداءً من الأسبوع 28، عدّي حركات الجنين يومياً. تواصلي مع طبيبك 
                إذا لاحظتِ انخفاضاً في الحركة أو لم تصلي إلى 10 ركلات في ساعتين.
              </p>
            </div>
          </motion.div>
        </div>
