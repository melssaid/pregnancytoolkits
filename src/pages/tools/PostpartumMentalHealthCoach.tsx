                        ...
                        <>
                          ...
                          {!aiLoading && (
                            <Button
                              ...
                              className="w-full mt-4 border-violet-300 text-violet-700 dark:text-violet-300 hover:bg-violet-50 dark:hover:bg-violet-950/30 disabled:opacity-70 disabled:text-violet-700"
                            >
                              {isExportingPDF ? (
                                <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                              ) : (
