...
const definedRoutes = [
  ...
  "/tools/smart-grocery-list", "/tools/smart-plan", "/tools/smart-walking-coach",
  "/tools/smart-stretch-reminder", "/tools/smart-snack-planner", "/tools/ai-sleep-optimizer",
  ...
  "/tools/forbidden-foods", "/tools/labor-progress", "/tools/ai-birth-plan",
